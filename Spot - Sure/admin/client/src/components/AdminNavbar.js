...
const AdminNavbar = () => {
  ...
  const logOut = () => {
    fetch("http://localhost:4001/admin/logout", {
      method: "GET",
      credentials: "include",
    })
      .then((res) => {
        ...
        <div className="container-fluid" style={{ backgroundColor: "#181e1e" }}>
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto p-4 mb-0 mb-lg-0">
              ...
              <li className="nav-item pe-4">
                <NavLink className="nav-link text-white" to="/manageUsers">
                  Manage Users
                </NavLink>
              </li>
              ...
              <li className="nav-item pe-4">
                <NavLink className="nav-link text-white" to="/togglePark">
                  Park Vehicles
                </NavLink>
              </li>
              <li className="nav-item pe-4">
                <NavLink className="nav-link text-white" to="/approveUsers">
                  Approve Users
                </NavLink>
              </li>
